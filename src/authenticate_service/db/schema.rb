...
ActiveRecord::Schema[7.1].define(version: 2024_03_23_182149) do
  create_schema "crdb_internal"

  create_table "lambda_history", force: :cascade do |t|
    t.bigint "count", null: false
    t.bigint "mean", null: false
    t.float "std", null: false
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.unique_constraint ["unlock_token"], name: "index_users_on_unlock_token"
  end
